...
class ModelBrtRestApiShipmentRequest extends \ObjectModel
{
    public $id_order;
    ...
    public static $definition = [
        'table' => 'brt_restapi_shipment_request',
        'primary' => 'id_brt_restapi_shipment_request',
        'fields' => [
            ...
            'request_json' => ['type' => self::TYPE_STRING, 'validate' => 'isString'],
    ...
    {
        $db = \Db::getInstance();
        $sql = 'CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'brt_restapi_shipment_request` (
    ...
    public static function uninstall(): bool
    {
        return (bool) \Db::getInstance()->execute(
            'DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'brt_restapi_shipment_request`'
        );
    }
    ...
    public static function getByIdOrder(int $idOrder)
    {
        ...
        $id = (int) \Db::getInstance()->getValue(
            'SELECT `id_brt_restapi_shipment_request` FROM `' . _DB_PREFIX_ . 'brt_restapi_shipment_request`
    ...
    public static function getAll(int $limit = 50, int $offset = 0): array
    {
        return \Db::getInstance()->executeS(
            'SELECT * FROM `' . _DB_PREFIX_ . 'brt_restapi_shipment_request`
             ORDER BY `date_add` DESC
    ...
    {
        $this->request_json = json_encode($data);
    }
}
